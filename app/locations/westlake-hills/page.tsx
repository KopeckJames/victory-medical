...
export default function WestlakeHillsLocationPage() {
  const clinicLd = {
    ...
    '@type': 'MedicalClinic',
    name: 'Victory Medical Westlake Hills',
    description: 'Primary care, urgent care, allergy treatment, MedSpa services, and MDVIP concierge medicine on Bee Caves Rd, Westlake Hills.',
    url: 'https://victorymed.com/locations/westlake-hills',
